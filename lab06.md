...
Для выполнения практической работы вам предварительно понадобится донастроить ВМ **mikrotik**. Подключитесь к маршрутизатору mikrotik с помощью **WinBox**(admin/zabbix) из ВМ **WINCLIENT**. Пропишите адреса на интерфейсах маршрутизатора в соответствии со схемой стенда, уточнить соответствие интерфейсов сетям стенда можно по MAC-адресам в свойствах ВМ **mikrotik**.
...
2. Назовите элемент **secure_log**. Тип: **Заббикс агент (активный)**
