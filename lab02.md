...
3. Укажите:  
   ...
   - **Ключ**: `ssh.run`.
   - **Тип информации**: лог  
   - **Тип аутентификации**: `Публичный Ключ`.  
...
9. Установите рекурсивно права на каталог **`/var/lib/zabbix/`** и файлы в нем для пользователя и группы **zabbix**.
...
```
11. Найдите,расскоментируйте и исправьте опцию в конфигурацию `/etc/zabbix/zabbix_server.conf`
```ini
